    ...
    <body>
        ...
        <div class="position-relative">
            ...
            <div class="position-absolute top-50 start-50 translate-middle text-center text-white px-4 py-3 rounded fade-in"
                ...
                <h1 class="display-4 fw-bold">Ingeniería Civil</h1>
            </div>
            <!-- Carrusel de fondo -->
            <div id="miCarrusel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imgUni/IC1.jpg" class="d-block w-100" alt="Campus 1" style="height: 500px; object-fit: cover;">
                    </div>
                    <div class="carousel-item">
                        <img src="imgUni/IC2.jpg" class="d-block w-100" alt="Campus 2" style="height: 500px; object-fit: cover;">
                    </div>
                </div>
        ...
        <div style="background-color: darkred; color: white; font-size: 50px; font-family: 'Arial Black', sans-serif; padding: 30px;">
            <p style="margin-left: 50px;">Ingeniería Civil</p>
        </div>
        ...
        <div style="max-width: 1000px; margin: 40px auto; padding: 0 60px; font-size: 18px; line-height: 1.7;">
            <p>
                La carrera de Ingeniería Civil en UGIC forma profesionales altamente capacitados para diseñar, planificar, construir y supervisar obras de infraestructura esenciales para el desarrollo del país, tales como edificaciones, carreteras, puentes, sistemas hidráulicos y estructuras urbanas. El enfoque de la carrera está orientado a la innovación, sostenibilidad y responsabilidad social en el ejercicio de la ingeniería.
            </p>

            <ul style="margin-top: 30px;">
                <li><strong>Grado Académico:</strong> Bachiller en Ingeniería Civil</li>
                <li><strong>Título Profesional:</strong> Ingeniero(a) Civil</li>
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Introducción a la Ingeniería Civil</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Física II (Electricidad y Magnetismo)</li>
                        <li>Materiales de Construcción</li>
                        <li>Topografía II</li>
                        <li>Computación Aplicada</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Resistencia de Materiales I</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Resistencia de Materiales II</li>
                        <li>Hidráulica General</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Análisis Estructural I</li>
                        <li>Mecánica de Suelos II</li>
                        <li>Hidrología Aplicada</li>
                        <li>Pavimentos y Carreteras</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Análisis Estructural II</li>
                        <li>Diseño de Concreto Armado I</li>
                        <li>Obras Hidráulicas</li>
                        <li>Vías de Comunicación I</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Diseño de Concreto Armado II</li>
                        <li>Diseño de Estructuras Metálicas</li>
                        <li>Vías de Comunicación II</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Fundaciones y Cimentaciones</li>
                        <li>Ingeniería Sísmica</li>
                        <li>Planeamiento y Control de Obras</li>
                        <li>Evaluación de Proyectos de Infraestructura</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Obras de Arte y Puentes</li>
                        <li>Gestión de Riesgos y Desastres</li>
                        <li>Electivo II</li>
                        <li>Seminario de Tesis II</li>
