...
<html>
    <head>
        ...
        <style>
            ...
            /* Mejoras para el botón "Nuevo Profesor" / "Nuevo Horario" */
            .btn-nuevo-profesor { /* Renombrado para ser más genérico o crea uno específico para horario */
                ...
                <div class="col py-3">            
                    <center>
                        <div class="card card_tabla shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="row mb-4 align-items-center"> <%-- mb-4 para más espacio --%>
                                    <div class="col-sm-auto">
                                        <%-- Enlace para crear un nuevo horario --%>
                                        <a href="../HorarioController?pagina=nuevo" class="btn-nuevo-profesor"> <%-- Clase aplicada para estilos --%>
                                                ...
                                                <td class="text-center">
                                                    <div class="action-buttons">
                                                        ...
                                                        <a href="../HorarioController?pagina=ver&id=<%= hor.getIdHorario() %>" 
                                                           class="btn-action btn-info" data-tooltip="Ver detalles">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="../HorarioController?pagina=editar&id=<%= hor.getIdHorario() %>" 
                                                           class="btn-action btn-warning" data-tooltip="Editar">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="../HorarioController?pagina=eliminar&id=<%= hor.getIdHorario() %>" 
                                                           class="btn-action btn-danger" data-tooltip="Eliminar"
            ...
            buttons: [
                {
                    ...
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4] // Columnas a exportar (ID, Día, Hora Inicio, Hora Fin, Aula)
                    }
                },
                {
                    extend: 'pdfHtml5',
                    ...
                    orientation: 'portrait', // Orientación vertical para menos columnas
                    pageSize: 'A4',
                    exportOptions: {
                ...
                },
                {
                    ...
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4] // Columnas a imprimir
                    }
                }
            ],
            language: {
