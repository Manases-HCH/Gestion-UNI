    ...
    <body>
        ...
        <div class="position-relative">
            ...
            <div class="position-absolute top-50 start-50 translate-middle text-center text-white px-4 py-3 rounded fade-in"
                ...
                <h1 class="display-4 fw-bold">Arquitectura</h1>
            </div>
            <!-- Carrusel de fondo -->
            <div id="miCarrusel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imgUni/A1.jpg" class="d-block w-100" alt="Campus 1" style="height: 500px; object-fit: cover;">
                    </div>
                    <div class="carousel-item">
                        <img src="imgUni/A.jpg" class="d-block w-100" alt="Campus 2" style="height: 500px; object-fit: cover;">
                    </div>
                </div>
        ...
        <div style="background-color: darkred; color: white; font-size: 50px; font-family: 'Arial Black', sans-serif; padding: 30px;">
            <p style="margin-left: 50px;">Arquitectura</p>
        </div>
        ...
        <div style="max-width: 1000px; margin: 40px auto; padding: 0 60px; font-size: 18px; line-height: 1.7;">
            <p>
                La carrera de Arquitectura en UGIC está orientada a la formación de profesionales capaces de diseñar, planificar y construir espacios que respondan de manera creativa, funcional y sostenible a las necesidades humanas. La arquitectura es una disciplina que integra el arte, la ciencia, la tecnología y el compromiso social para transformar el entorno urbano y natural.
            </p>

            <ul style="margin-top: 30px;">
                <li><strong>Grado Académico:</strong> Bachiller en Arquitectura</li>
                <li><strong>Título Profesional:</strong> Arquitecto(a)</li>
        ...
        <div style="max-width: 1000px; margin: 60px auto; padding: 0 60px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Fundamentos del Diseño Arquitectónico</li>
                        <li>Dibujo Técnico y Geométrico</li>
                        <li>Historia del Arte y la Arquitectura I</li>
                        <li>Matemáticas Aplicadas a la Arquitectura</li>
                        <li>Taller de Representación Gráfica</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Diseño Arquitectónico I</li>
                        <li>Historia del Arte y la Arquitectura II</li>
                        <li>Geometría Descriptiva</li>
                        <li>Materiales de Construcción</li>
                        <li>Comunicación Visual</li>
                        <li>Física para Arquitectura</li>
                    </ul>
                </div>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Diseño Arquitectónico II</li>
                        <li>Taller de Maquetas y Modelado</li>
                        <li>Instalaciones Sanitarias y Eléctricas</li>
                        <li>Sistemas Constructivos I</li>
                        <li>Teoría de la Arquitectura I</li>
                        <li>Topografía y Geomática</li>
                    </ul>
                </div>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Diseño Arquitectónico III (Vivienda Unifamiliar)</li>
                        <li>Historia de la Arquitectura Peruana y Latinoamericana</li>
                        <li>Urbanismo I: Fundamentos del Planeamiento Urbano</li>
                        <li>Sistemas Constructivos II</li>
                        <li>Sostenibilidad y Medio Ambiente</li>
                        <li>Expresión Digital I (AutoCAD, SketchUp)</li>
                    </ul>
                </div>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Diseño Arquitectónico IV (Vivienda Colectiva)</li>
                        <li>Instalaciones Mecánicas y Especiales</li>
                        <li>Urbanismo II: Diseño de Espacios Públicos</li>
                        <li>Teoría de la Arquitectura II</li>
                        <li>Estructuras I (Estática y Resistencia de Materiales)</li>
                        <li>Expresión Digital II (Revit, BIM básico)</li>
                    </ul>
                </div>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Diseño Arquitectónico V (Equipamiento Urbano)</li>
                        <li>Arquitectura Bioclimática y Eficiencia Energética</li>
                        <li>Estructuras II (Concreto Armado y Acero)</li>
                        <li>Taller de Paisajismo</li>
                        <li>Normativa Urbana y Edilicia</li>
                        <li>Taller de Proyectos Interdisciplinarios</li>
                    </ul>
                </div>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Diseño Arquitectónico VI (Espacios Culturales o Educativos)</li>
                        <li>Gestión y Administración de Obras</li>
                        <li>Patrimonio Arquitectónico y Restauración</li>
                        <li>Urbanismo III (Desarrollo Urbano Sostenible)</li>
                        <li>Modelado Avanzado BIM</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Diseño Arquitectónico VII (Equipamiento Complejo)</li>
                        <li>Proyecto Urbano y Ordenamiento Territorial</li>
                        <li>Ética y Responsabilidad Profesional</li>
                        <li>Costos y Presupuestos de Obras</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Taller de Diseño Arquitectónico Final</li>
                        <li>Gestión de Proyectos Arquitectónicos</li>
                        <li>Evaluación de Impacto Ambiental</li>
                        <li>Taller de Preparación de Tesis</li>
