    ...
    <body>
        ...
        <div class="position-relative">
            ...
            <div class="position-absolute top-50 start-50 translate-middle text-center text-white px-4 py-3 rounded fade-in"
                ...
                <h1 class="display-4 fw-bold">Ingeniería Industrial</h1>
            </div>
            <!-- Carrusel de fondo -->
            <div id="miCarrusel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imgUni/II1.jpg" class="d-block w-100" alt="Campus 1" style="height: 500px; object-fit: cover;">
                    </div>
                    <div class="carousel-item">
                        <img src="imgUni/II2.jpg" class="d-block w-100" alt="Campus 2" style="height: 500px; object-fit: cover;">
                    </div>
                </div>
        ...
        <div style="background-color: darkred; color: white; font-size: 50px; font-family: 'Arial Black', sans-serif; padding: 30px;">
            <p style="margin-left: 50px;">Ingeniería Industrial</p>
        </div>
        ...
        <div style="max-width: 1000px; margin: 40px auto; padding: 0 60px; font-size: 18px; line-height: 1.7;">
            <p>
                La carrera de Ingeniería Industrial en UGIC forma profesionales capaces de diseñar, optimizar y gestionar sistemas productivos, logísticos y administrativos, buscando siempre la eficiencia, la calidad y la sostenibilidad. Su enfoque multidisciplinario permite al ingeniero industrial liderar procesos de mejora continua en organizaciones de cualquier sector económico, integrando conocimientos técnicos, económicos, humanos y tecnológicos.
            </p>

            <ul style="margin-top: 30px;">
                <li><strong>Grado Académico:</strong> Bachiller en Ingeniería Industrial</li>
                <li><strong>Título Profesional:</strong> Ingeniero(a) Industrial</li>
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Introducción a la Ingeniería Industrial</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Física III (Ondas y Termodinámica)</li>
                        <li>Programación Aplicada</li>
                        <li>Contabilidad de Costos</li>
                        <li>Investigación Operativa I</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Legislación Industrial y Laboral</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Sistemas de Gestión Integrados</li>
                        <li>Automatización y Control Industrial</li>
                        <li>Planeamiento y Control de la Producción</li>
                        <li>Gestión de Proyectos</li>
                        <li>Sistemas de Información Gerencial</li>
