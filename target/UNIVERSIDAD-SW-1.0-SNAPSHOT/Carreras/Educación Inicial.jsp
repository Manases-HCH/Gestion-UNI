    ...
    <body>
        ...
        <div class="position-relative">
            ...
            <div class="position-absolute top-50 start-50 translate-middle text-center text-white px-4 py-3 rounded fade-in"
                ...
                <h1 class="display-4 fw-bold">Educación Inicial</h1>
            </div>
            <!-- Carrusel de fondo -->
            <div id="miCarrusel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imgUni/EI1.jpg" class="d-block w-100" alt="Campus 1" style="height: 500px; object-fit: cover;">
                    </div>
                    <div class="carousel-item">
                        <img src="imgUni/EI2.jpg" class="d-block w-100" alt="Campus 2" style="height: 500px; object-fit: cover;">
                    </div>
                </div>
        ...
        <div style="background-color: darkred; color: white; font-size: 50px; font-family: 'Arial Black', sans-serif; padding: 30px;">
            <p style="margin-left: 50px;">Educación Inicial</p>
        </div>
        ...
        <div style="max-width: 1000px; margin: 40px auto; padding: 0 60px; font-size: 18px; line-height: 1.7;">
            <p>
                La carrera de Educación Inicial en UGIC forma profesionales capaces de atender integralmente a niñas y niños en la primera etapa de su desarrollo, desde los 0 hasta los 6 años. Su objetivo principal es formar docentes con una sólida base pedagógica, psicológica y ética, capaces de crear experiencias educativas significativas que promuevan el desarrollo cognitivo, emocional, social y físico de los niños en sus primeros años de vida.
            </p>

            <ul style="margin-top: 30px;">
                <li><strong>Grado Académico:</strong> Bachiller en Educación Inicial</li>
                <li><strong>Título Profesional:</strong> Licenciado(a) en Educación Inicial</li>
        ...
        <div style="max-width: 1000px; margin: 60px auto; padding: 0 60px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Fundamentos de la Educación</li>
                        <li>Psicología General</li>
                        <li>Comunicación Oral y Escrita</li>
                        <li>Desarrollo Infantil I (0 a 3 años)</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Realidad Educativa Nacional</li>
                        <li>Desarrollo Infantil II (3 a 6 años)</li>
                        <li>Introducción a la Educación Inicial</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Juego y Aprendizaje en la Primera Infancia</li>
                        <li>Didáctica de la Expresión Corporal</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Evaluación del Aprendizaje en Educación Inicial</li>
                        <li>Didáctica de la Comunicación Oral y Escrita</li>
                        <li>Expresión Musical y Rítmica</li>
                        <li>Familia y Comunidad en Educación Inicial</li>
                        <li>Taller de Materiales Didácticos</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Currículo Nacional de Educación Inicial</li>
                        <li>Didáctica del Pensamiento Matemático en la Infancia</li>
                        <li>Didáctica del Área Ciencia y Ambiente</li>
                        <li>Educación Inclusiva</li>
                        <li>Taller de Juegos Didácticos</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Planificación Curricular en Educación Inicial</li>
                        <li>Expresión Plástica y Creatividad</li>
                        <li>Prácticas Preprofesionales I</li>
                        <li>Gestión de Aula y Clima Escolar</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Diseño y Evaluación de Proyectos Educativos</li>
                        <li>Estrategias de Atención a la Diversidad</li>
                        <li>Tutoría y Orientación Infantil</li>
                        <li>Electivo II</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Gestión y Liderazgo en Instituciones Iniciales</li>
                        <li>Diseño de Recursos Digitales para el Nivel Inicial</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Prácticas Preprofesionales IV</li>
                        <li>Ética Profesional y Legislación Educativa</li>
                        <li>Taller de Innovación Pedagógica</li>
                        <li>Taller de Producción de Tesis</li>
                        <li>Taller de Reflexión Docente</li>
                    </ul>
                </div>
                <!-- Ciclo 10 -->
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Prácticas Preprofesionales V (Internado Educativo)</li>
                        <li>Gestión de Proyectos Educativos Innovadores</li>
                        <li>Defensa del Trabajo de Investigación Final</li>
                        <li>Evaluación Integral de Competencias</li>
                        <li>Electivo IV</li>
                    </ul>
                </div>
            </div>
