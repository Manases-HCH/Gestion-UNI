    ...
    <body>
        ...
        <div class="position-relative">
            ...
            <div class="position-absolute top-50 start-50 translate-middle text-center text-white px-4 py-3 rounded fade-in"
                ...
                <h1 class="display-4 fw-bold">Psicología</h1>
            </div>
            <!-- Carrusel de fondo -->
            <div id="miCarrusel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imgUni/P1.jpg" class="d-block w-100" alt="Campus 1" style="height: 500px; object-fit: cover;">
                    </div>
                    <div class="carousel-item">
                        <img src="imgUni/P2.jpg" class="d-block w-100" alt="Campus 2" style="height: 500px; object-fit: cover;">
                    </div>
                </div>
        ...
        <div style="background-color: darkred; color: white; font-size: 50px; font-family: 'Arial Black', sans-serif; padding: 30px;">
            <p style="margin-left: 50px;">Psicología</p>
        </div>
        ...
        <div style="max-width: 1000px; margin: 40px auto; padding: 0 60px; font-size: 18px; line-height: 1.7;">
            <p>
                La carrera de Psicología en UGIC forma profesionales comprometidos con el bienestar mental, emocional y social de las personas, capaces de comprender, evaluar e intervenir en los diversos procesos psicológicos que afectan la conducta humana. Con una sólida formación científica, ética y humanística, los estudiantes adquieren las herramientas necesarias para abordar los desafíos actuales de la salud mental en contextos individuales, familiares, educativos, organizacionales y comunitarios.
            </p>

            <ul style="margin-top: 30px;">
                <li><strong>Grado Académico:</strong> Bachiller en Psicología</li>
                <li><strong>Título Profesional:</strong> Licenciado(a) en Psicología</li>
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Fundamentos de Filosofía</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Psicología del Desarrollo I (Infancia)</li>
                        <li>Sociología</li>
                        <li>Realidad Nacional y Global</li>
                    </ul>
                </div>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Psicología del Desarrollo II (Adolescencia y Juventud)</li>
                        <li>Psicobiología</li>
                        <li>Estadística Inferencial</li>
                        <li>Fundamentos de Psicología Social</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Psicología del Desarrollo III (Adultez y Vejez)</li>
                        <li>Psicología Cognitiva</li>
                        <li>Técnicas de Observación y Entrevista</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Psicología Clínica I</li>
                        <li>Psicopatología I (Niños y Adolescentes)</li>
                        <li>Evaluación Psicológica I (Niños y Adolescentes)</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Psicología Clínica II</li>
                        <li>Psicopatología II (Adultos)</li>
                        <li>Evaluación Psicológica II (Adultos)</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Intervención Psicoterapéutica I</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Intervención Psicoterapéutica II</li>
                        <li>Psicología de Emergencias y Desastres</li>
                        <li>Programas de Prevención y Promoción de la Salud Mental</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Supervisión de Casos Clínicos</li>
                        <li>Psicoterapia Breve y Estrategias Cognitivo-Conductuales</li>
                        <li>Prácticas Preprofesionales I</li>
                        <li>Ética Profesional y Deontología Psicológica</li>
                        <li>Taller de Habilidades Terapéuticas</li>
                    </ul>
                </div>
                <!-- Ciclo 10 -->
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Intervención en Crisis y Violencia</li>
                        <li>Prácticas Preprofesionales II</li>
                        <li>Taller de Inserción Laboral del Psicólogo</li>
                        <li>Electivo III </li>
