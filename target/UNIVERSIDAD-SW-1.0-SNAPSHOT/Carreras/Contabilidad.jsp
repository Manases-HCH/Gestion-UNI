    ...
    <body>
        ...
        <div class="position-relative">
            ...
            <div class="position-absolute top-50 start-50 translate-middle text-center text-white px-4 py-3 rounded fade-in"
                ...
                <h1 class="display-4 fw-bold">Contabilidad</h1>
            </div>
            <!-- Carrusel de fondo -->
            <div id="miCarrusel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imgUni/C1.jpg" class="d-block w-100" alt="Campus 1" style="height: 500px; object-fit: cover;">
                    </div>
                    <div class="carousel-item">
                        <img src="imgUni/C2.jpg" class="d-block w-100" alt="Campus 2" style="height: 500px; object-fit: cover;">
                    </div>
                </div>
        ...
        <div style="background-color: darkred; color: white; font-size: 50px; font-family: 'Arial Black', sans-serif; padding: 30px;">
            <p style="margin-left: 50px;">Contabilidad</p>
        </div>
        ...
        <div style="max-width: 1000px; margin: 40px auto; padding: 0 60px; font-size: 18px; line-height: 1.7;">
            <p>
                La carrera de Contabilidad en UGIC forma profesionales capaces de registrar, analizar e interpretar la información financiera de una organización, convirtiéndose en pilares clave para la toma de decisiones estratégicas. A través de una formación integral, el estudiante adquiere competencias en contabilidad financiera, costos, auditoría, tributación, control interno, ética profesional y tecnologías aplicadas a la gestión contable.
            </p>
            <ul style="margin-top: 30px;">
                <li><strong>Grado Académico:</strong> Bachiller en Ciencias Contables</li>
                <li><strong>Título Profesional:</strong> Contador(a) Público</li>
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Sistemas Contables Computarizados</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Contabilidad Tributaria II</li>
                        <li>Auditoría I – Fundamentos</li>
                        <li>Gestión Financiera II</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Contabilidad Internacional (NIIF)</li>
                        <li>Auditoría III – Informes</li>
                        <li>Tributación Municipal y Especiales</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Tributación Internacional</li>
                        <li>Revisoría Fiscal</li>
                        <li>Práctica de Aplicación Profesional I</li>
                        <li>Ética y Deontología Contable</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Práctica de Aplicación Profesional II</li>
                        <li>Legislación Contable Internacional</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Taller Integrador Contable</li>
                        <li>Simulación Empresarial Contable</li>
                        <li>Normas Internacionales de Auditoría (NIA)</li>
                        <li>Defensa del Trabajo de Investigación Final</li>
                        <li>Prácticas Preprofesionales Supervisionadas</li>
                    </ul>
                </div>
            </div>
        </div>
