...
<html>
    <head>
        ...
        <style>
            ...
            /* Mejoras para el botón "Nueva Clase" */
            .btn-nueva-clase {
                    ...
                    <center>
                        <div class="card card_tabla shadow-sm">
                            <div class="card-header card_titulo bg-primary text-white">
                                <h2 class="mb-0">
                                    <i class="fas fa-chalkboard-teacher me-2"></i>Gestión de Clases <%-- Icono de clase y texto "Gestión de Clases" --%>
                                </h2>
                            </div>
                            <div class="card-body">
                                <div class="row mb-4 align-items-center">
                                    <div class="col-sm-auto">
                                        ...
                                        <a href="../ClaseController?pagina=nuevo" class="btn-nueva-clase">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="action-buttons">
                                                    ...
                                                    <a href="../ClaseController?pagina=ver&id=<%= cl.getIdClase() %>"
                                                       class="btn-action btn-info"
                                                       data-tooltip="Ver detalles">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="../ClaseController?pagina=editar&id=<%= cl.getIdClase() %>"
                                                       class="btn-action btn-warning"
                                                       data-tooltip="Editar">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="../ClaseController?pagina=eliminar&id=<%= cl.getIdClase() %>"
                                                       class="btn-action btn-danger"
                                                       data-tooltip="Eliminar"
                                                       onclick="return confirm('¿Está seguro que desea eliminar esta clase? Esta acción no se puede deshacer.')">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#myTable').DataTable({
            ...
            buttons: [
                {
                    ...
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4] // Columnas a exportar para Clases
                    }
                },
                {
                    extend: 'pdfHtml5',
            ...
            responsive: true,
            columnDefs: [
                { targets: 5, orderable: false } // Deshabilitar ordenamiento en la columna de acciones (índice 5)
            ],
