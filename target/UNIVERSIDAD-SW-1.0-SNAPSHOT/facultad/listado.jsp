...
<html>
    <head>
        ...
        <style>
            ...
            /* Mejoras para el botón "Nueva Facultad" */
            .btn-nueva-facultad { /* Nueva clase para el botón de "Nueva Facultad" */
                    ...
                    <center>
                        <div class="card card_tabla shadow-sm">
                            <div class="card-header card_titulo bg-primary text-white">
                                <h2 class="mb-0">
                                    <i class="fas fa-building me-2"></i>Gestión de Facultades <%-- Icono de edificio y texto "Gestión de Facultades" --%>
                                </h2>
                            </div>
                            <div class="card-body">
                                <div class="row mb-4 align-items-center"> <%-- mb-4 align-items-center para layout DataTables --%>
                                    <div class="col-sm-auto">
                                        ...
                                        <a href="../FacultadController?pagina=nuevo" class="btn-nueva-facultad">
                                            <i class="fas fa-plus-circle"></i> Nueva Facultad
                                        </a>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#myTable').DataTable({
            ...
            buttons: [
                {
                    ...
                    exportOptions: {
                        columns: [0, 1] // Columnas a exportar para Facultades (ID Facultad, Nombre de la Facultad)
                    }
                },
                {
                    extend: 'pdfHtml5',
                    ...
                    pageSize: 'A4',
                    exportOptions: {
                        columns: [0, 1] // Columnas a exportar para Facultades
                    },
                    customize: function (doc) {
                        var colCount = doc.content[1].table.body[0].length;
                        // Ajustar anchos de columna para PDF. Para 2 columnas.
            ...
            responsive: true,
            columnDefs: [
                { targets: 1, orderable: false } // Deshabilitar ordenamiento en la columna de acciones (índice 2)
            ],
