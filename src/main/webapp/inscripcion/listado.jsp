...
<html>
    <head>
        ...
        <style>
            ...
            /* Mejoras para el botón "Nueva Inscripción" */
            .btn-nueva-inscripcion { /* Nueva clase para el botón de "Nueva Inscripción" */
                background: linear-gradient(45deg, #0d6efd, #0b5ed7); /* Color primario o similar para Nueva Inscripción */
                border: none;
                border-radius: 10px;
                padding: 12px 24px;
                font-weight: 600;
                            ...
                            <div class="card-body">
                                <div class="row mb-4 align-items-center">
                                    <div class="col-sm-auto">
                                        ...
                                        <a href="${pageContext.request.contextPath}/InscripcionController?pagina=nuevo" class="btn-nueva-inscripcion">
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="display table table-light table-striped table-hover card_contenido align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr>
                                                <td><%= ins.getNombreAlumno() %></td>
                                                <td><%= ins.getApellidoAlumno() %></td>
                                                <td><%= ins.getNombreCurso() %></td>
            ...
            buttons: [
                {
                    ...
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5] // Columnas a exportar (ID, Nombre Alumno, Apellido Alumno, Nombre Curso, Fecha, Estado)
                    }
                },
                {
                    extend: 'pdfHtml5',
                    ...
                    orientation: 'landscape', // Orientación landscape si hay muchas columnas
                    pageSize: 'A4',
                    exportOptions: {
                    ...
                    customize: function (doc) {
                        ...
                        // Ajustar anchos de columna para PDF. Para 6 columnas.
                        doc.content[1].table.widths = Array(colCount).fill('*'); // Distribuye el ancho uniformemente

                        doc.defaultStyle.fontSize = 8;
                        doc.pageMargins = [10, 20, 10, 20]; // Márgenes ajustados para landscape
