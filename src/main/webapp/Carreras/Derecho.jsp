    ...
    <body>
        ...
        <div class="position-relative">
            ...
            <div class="position-absolute top-50 start-50 translate-middle text-center text-white px-4 py-3 rounded fade-in"
                ...
                <h1 class="display-4 fw-bold">Derecho</h1>
            </div>
            <!-- Carrusel de fondo -->
            <div id="miCarrusel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imgUni/D1.jpg" class="d-block w-100" alt="Campus 1" style="height: 500px; object-fit: cover;">
                    </div>
                    <div class="carousel-item">
                        <img src="imgUni/D2.jpg" class="d-block w-100" alt="Campus 2" style="height: 500px; object-fit: cover;">
                    </div>
                </div>
        ...
        <div style="background-color: darkred; color: white; font-size: 50px; font-family: 'Arial Black', sans-serif; padding: 30px;">
            <p style="margin-left: 50px;">Derecho</p>
        </div>
        ...
        <div style="max-width: 1000px; margin: 40px auto; padding: 0 60px; font-size: 18px; line-height: 1.7;">
            <p>
                La carrera de Derecho en UGIC forma profesionales capaces de interpretar, aplicar y crear normas jurídicas con un enfoque ético, crítico y humanista. El programa académico combina sólidos conocimientos teóricos con una intensa formación práctica, orientada a la resolución de conflictos, la justicia social y la defensa de los derechos fundamentales. Los estudiantes se preparan para actuar con responsabilidad en diversos ámbitos del Derecho, tanto a nivel nacional como internacional.
            </p>
            <ul style="margin-top: 30px;">
                <li><strong>Grado Académico:</strong> Bachiller en Derecho</li>
                <li><strong>Título Profesional:</strong> Abogado(a)</li>
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 30px;">
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Sociología Jurídica</li>
                        <li>Teoría General del Derecho</li>
                        <li>Filosofía del Derecho</li>
                        <li>Derecho Constitucional I</li>
                        <li>Inglés Jurídico I</li>
                    </ul>
                </div>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Derecho Civil II – Personas y Familia</li>
                        <li>Derecho Penal II – Parte Especial</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Derecho Civil III – Obligaciones</li>
                        <li>Derecho Procesal Penal I</li>
                        <li>Derecho Administrativo II</li>
                        <li>Derecho del Trabajo I</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Derecho Civil IV – Contratos</li>
                        <li>Derecho Procesal Penal II</li>
                        <li>Derecho Procesal Administrativo</li>
                        <li>Derecho del Trabajo II</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Derecho Civil V – Derechos Reales</li>
                        <li>Derecho Procesal Civil I</li>
                        <li>Derecho Empresarial I</li>
                        <li>Derecho Tributario I</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Derecho Civil VI – Sucesiones</li>
                        <li>Derecho Procesal Civil II</li>
                        <li>Derecho Empresarial II</li>
                        <li>Derecho Tributario II</li>
                        <li>Clínica Jurídica II</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        <li>Arbitraje y Resolución Alternativa de Conflictos</li>
                        <li>Derecho Notarial y Registral</li>
                        <li>Derecho de la Niñez y Adolescencia</li>
                ...
                <div style="border: 2px solid darkred; border-radius: 10px; padding: 20px;">
                    ...
                    <ul>
                        ...
                        <li>Deontología y Ética Jurídica</li>
                        <li>Electivo IV</li>
