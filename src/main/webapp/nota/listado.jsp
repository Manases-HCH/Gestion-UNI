...
<%@page import="java.util.LinkedList, pe.edu.entity.Nota, pe.edu.dao.NotaDao" %>
<!DOCTYPE html>
<html>
    <head>
        ...
        <style>
            ...
            /* Mejoras para el botón "Nueva Nota" */
            .btn-nuevo-nota {
                    ...
                    <center>
                        <div class="card card_tabla shadow-sm">
                            <div class="card-header card_titulo bg-primary text-white">
                                <h2 class="mb-0">
                                    <i class="fas fa-clipboard-check me-2"></i>Gestión de Notas
                                </h2>
                            </div>
                            <div class="card-body">
                                <div class="row mb-4 align-items-center">
                                    <div class="col-sm-auto">
                                        <%-- Enlace para crear una nueva nota --%>
                                        <a href="../NotaController?pagina=nuevo" class="btn-nuevo-nota">
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="display table table-light table-striped table-hover card_contenido align-middle">
                                        ...
                                        <tbody>
                                            <%
                                                LinkedList<Nota> listaNotas = notaDao.listar();
                                                if (listaNotas == null) {
                                            ...
                                            %>
                                            <tr>
                                                <td><%= n.getIdInscripcion() %></td>
                                                <td><%= n.getNota1() %></td>
                                                <td><%= n.getNota2() %></td>
                                                <td><%= n.getNotaFinal() %></td>
                                                <td><%= n.getEstado() %></td>
                                                <td class="text-center">
                                                    <div class="action-buttons">
                                                        <%-- Enlaces para Ver, Editar y Eliminar --%>
                                                        <a href="../NotaController?pagina=ver&id=<%= n.getIdNota() %>"
                                                           class="btn-action btn-info"
                                                           data-tooltip="Ver detalles">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="../NotaController?pagina=editar&id=<%= n.getIdNota() %>"
                                                           class="btn-action btn-warning"
                                                           data-tooltip="Editar">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="../NotaController?pagina=eliminar&id=<%= n.getIdNota() %>"
                                                           class="btn-action btn-danger"
                                                           data-tooltip="Eliminar"
                                                           onclick="return confirm('¿Está seguro que desea eliminar esta nota? Esta acción no se puede deshacer.')">
            ...
            buttons: [
                {
                    ...
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5] // Columnas a exportar (todas excepto Acciones)
                    }
                },
                {
                    extend: 'pdfHtml5',
                ...
                },
                {
                    ...
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5, 6] // Todas las columnas para imprimir
                    }
                }
            ],
            language: {
